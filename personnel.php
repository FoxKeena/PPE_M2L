        ...
        <div class="panel panel-default" id="locaux">
            ...
            <div class="panel-body">
				...
				<ul style="list-style-type:none"><h3>
					...
					<li>1 ETP sur l’accueil qui va bientôt passer en deux fois 0,5 ETP.</li><h3>
				</ul><br/>
				<h3>Vous parliez du Plan Impact Emploi Association. De quoi s’agit-il ?<br/><br/>
				...
				En ce moment, sous l’impulsion du ministère, nous œuvrons au développement de l’usage du chèque emploi associatif.</h3>
			</div>
		</div>
	</div>